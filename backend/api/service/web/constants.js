...
const APP_DOWNLOAD_URL_IOS = (process.env.APP_DOWNLOAD_URL_IOS || process.env.APP_DOWNLOAD_URL || '').trim()
...
const APP_PACKAGE_ANDROID = process.env.APP_PACKAGE_ANDROID || 'com.biopass'
